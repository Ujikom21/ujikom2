                    ...
                    <form method="post" action="transaksi_update.php">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="paket" required="required">
                                ...
                                while($d=mysqli_fetch_array($data)){
                                    ?>
                                    <option <?php if($d['nama_paket']==$t['transaksi_paket']){echo "selected='selected'";} ?> value="<?php echo $d['nama_paket']; ?>"><?php echo $d['nama_paket']; ?></option>
                                    <?php
                                }
                                ?>
                            </select>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            $pakaian = mysqli_query($koneksi,"select * from item where item_transaksi='$id_transaksi'");
                            while($p=mysqli_fetch_array($pakaian)){
                                ?>
                                <tr>
                                    <td><input type="text" class="form-control" name="jenis_pakaian[]" value="<?php echo $p['item_jenis']; ?>"></td>
                                    <td><input type="number" class="form-control" name="jumlah_pakaian[]" value="<?php echo $p['item_jumlah']; ?>"></td>
                                </tr>
                                <?php } ?>
                                <tr>
